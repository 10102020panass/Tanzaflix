(async function(){
  ...
  try {
    ...
    const res = await fetch(`http://localhost:5000/api/content?${queryString}`);
    ...
    moviesList.innerHTML = '<p style="color:#fca5a5">Hitilafu ya kuwasiliana na server. Hakikisha backend inakimbia (http://localhost:5000).</p>';
    console.error(e);
  }
})();
